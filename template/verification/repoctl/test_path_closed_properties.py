...
@pytest.mark.proof
@pytest.mark.proves("REPOCTL::PLAN-PATH-CLOSED")
...
def test_successful_classification_is_closed(
    ...
    assert_property(
        ...
        property_id="REPOCTL::PLAN-PATH-CLOSED",
    )
    assert result == expected.name


@pytest.mark.proof
@pytest.mark.falsifies("REPOCTL::PLAN-PATH-CLOSED")
...
def test_script_facade_has_no_second_classification_implementation() -> None:
    ...
    domain_imports = {
        ...
        and node.module == "repoctl.modules.repository_generation.api"
