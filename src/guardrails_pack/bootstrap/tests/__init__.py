...
`acceptance/` sits below this package. Those assertions carry the `acceptance`
marker, the `tests` hook of the gate excludes that marker, and Terminal
Projection deletes the whole capability with them.
"""
