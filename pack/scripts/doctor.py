...
def inspect_prek_hooks(root: Path) -> HookInspection:
    """Report whether this repository carries the pack-owned prek git hooks."""
    ...
    completed = run_command(GIT_COMMON_DIR_COMMAND, root)
    ...
    if defects:
        return HookInspection(configured=True, installed=False, detail="; ".join(defects))
    return HookInspection(
        configured=True,
        installed=True,
