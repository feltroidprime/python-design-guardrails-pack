...
This module left the deleted control plane in ticket I1 (#87, entanglement
1). It imports nothing outside the standard library and `icontract`.
"""
...
from scripts.path_classifier_specifications import (
    OwnershipRootFacts,
...
@icontract.ensure(
    ...
    description="PROPERTY[PATH-CLOSED]",
)
def classify_path(
    candidate: RepositoryPathCandidate,
    zones: tuple[OwnershipZoneRoots, ...],
